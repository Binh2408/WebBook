USE [AssgnPRJ2]
GO
/****** Object:  Table [dbo].[Account]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Cart]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Category]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetail]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[product]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Shipping]    Script Date: 3/23/2023 2:57:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[OrderDetail] ([id], [order_id], [productName], [productImage], [productPrice], [quantity]) VALUES (1050, 1022, N'Nanh trắng', N'https://salt.tikicdn.com/cache/280x280/media/catalog/product/n/a/nanh-trang-300.u335.d20160505.t105441.jpg', 160, 1)
GO
INSERT [dbo].[OrderDetail] ([id], [order_id], [productName], [productImage], [productPrice], [quantity]) VALUES (1051, 1022, N'Tiếng gọi nơi hoang dã', N'https://salt.tikicdn.com/media/catalog/product/i/m/img226_11.jpg', 100, 1)
GO
INSERT [dbo].[OrderDetail] ([id], [order_id], [productName], [productImage], [productPrice], [quantity]) VALUES (2050, 2022, N'Tiếng gọi nơi hoang dã', N'https://salt.tikicdn.com/media/catalog/product/i/m/img226_11.jpg', 100, 1)
GO
INSERT [dbo].[OrderDetail] ([id], [order_id], [productName], [productImage], [productPrice], [quantity]) VALUES (2051, 2022, N'Lịch sử hiện đại', N'https://salt.tikicdn.com/ts/product/45/1b/c2/e23f8afc23074c835ab525f56a06d154.jpg', 100, 1)
GO
...
GO
INSERT [dbo].[product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID]) VALUES (37, N'hoang', N'khjgf', 158.0000, N'kuyk', N'tỵtyjtyjt', 6, 1)
GO
INSERT [dbo].[product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID]) VALUES (38, N'gẻ', N'https://haycafe.vn/wp-content/uploads/2022/03/anh-sach.jpg', 643634.0000, N'ưeggweg', N'gewgewgwe', 3, 1)
GO
INSERT [dbo].[product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID]) VALUES (39, N'fsbfd', N'https://thietkekhainguyen.com/wp-content/uploads/2018/10/sach-anh-du-lich7-788x445.jpg', 65767.0000, N'ydgm', N'myrmtm', 3, 1)
GO
